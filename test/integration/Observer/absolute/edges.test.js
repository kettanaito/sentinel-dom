describe('Edges', function() {
  ...
  describe('edgeX + offsetX', function() {
    it('Open test page', () =>
      cy.openExample('absolute/edges/edge-x-offset-x.html'))
    ...
    it('Should reject: scrollX > edgeX + offsetX', function() {
      cy.scrollTo(
        Cypress.config('viewportWidth') + Cypress.env('targetSize') * 0.75 - 9,
        0,
      )
      cy.get('#target-02').should('not.have.class', Cypress.env('trackedClass'))
      cy.hook(cy.screenshot)
  ...
  describe('edgeY', function() {
    ...
    it('Should reject: scrollY > edgeY', function() {
      cy.scrollTo(
        0,
        Cypress.config('viewportHeight') + Cypress.env('targetSize') * 0.75,
      )
      cy.get('#target-02').should('not.have.class', Cypress.env('trackedClass'))
      cy.hook(cy.screenshot)
    })
  ...
  describe('edgeY + offsetY', function() {
    ...
    it('Open test page', () =>
      cy.openExample('absolute/edges/edge-y-offset-y.html'))
